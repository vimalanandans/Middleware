 ...
 *
 */
public class ComponentAImpl extends ComponentAImplParent implements ComponentA {
    ...
    public void methodA() {
        ...
        componentB.methodB();
        System.out.println("calling componentAImplParent.methodC() (from componentA.methodA())");
        methodC();
    }
}
