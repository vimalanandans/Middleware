package com.bezirk.middleware.java.ui.spheremanagement;
...
import com.bezirk.middleware.java.ui.util.TestUIMouseListener;
...
public class SphereManagementGUI extends JFrame {
     ...
     */
    public SphereManagementGUI(NetworkManager networkManager) {
        initSphereManagement();
        this.networkManager = networkManager;
    }

    public SphereManagementGUI(SphereAPI sphereForPC, Device bezirkDevice, NetworkManager networkManager) {
    ...
    public static void main(String... args) {
        EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                try {
                    final SphereManagementGUI frame = new SphereManagementGUI(new JavaNetworkManager());
    ...
    private void initSphereManagement() {
        ...
        JLabel lblQR;
        try {
            lblQR = new JLabel(new ImageIcon(SphereManager.getBezirkQRCode()
                    .getQRCode()));
...
//        }
    ...
    private void displayCatchCode(JFrame frame) {
        ...
        final String defaultSphereCode = SphereManager.getBezirkQRCode()
