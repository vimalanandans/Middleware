...
import com.bosch.upa.uhu.util.MockComms;
import com.bosch.upa.uhu.util.MockProtocolsForUhuPC;
...
public class ProxySendTest {
	...
	private final String sendfilePath = ProxyforServices.class.getClassLoader().getResource("streamingTest.txt").getPath();
