...
public class UPADeviceForPC implements UPADeviceInterface {
    ...
    public static Properties loadProperties(String file) throws Exception {
        ...
        // filesystem path)
        final InputStream propsInputStream = UPADeviceInterface.class
    ...
    public static void storeProperties(Properties props) throws IOException {
        final URL propsURL = UPADeviceInterface.class.getResource(PROPS);
