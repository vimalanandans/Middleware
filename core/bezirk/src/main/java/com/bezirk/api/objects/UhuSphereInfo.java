...
public class UhuSphereInfo {
	...
	private final ArrayList<com.bezirk.api.objects.UhuPipeInfo> pipeList;
	...
	public UhuSphereInfo(final String sphereID, final String sphereName,
			...
			final ArrayList<com.bezirk.api.objects.UhuPipeInfo> pipeList) {
	 ...
	 * @return the pipeList
	 */
	public final ArrayList<com.bezirk.api.objects.UhuPipeInfo> getPipeList() {
		return pipeList;
	}
