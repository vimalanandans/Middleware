...
public class SphereServiceManager
    ...
    public SphereServiceManager(com.bezirk.middleware.core.sphere.security.CryptoEngine cryptoEngine, Device device, SphereRegistry sphereRegistry, NetworkManager networkManager) {
