...
import com.bezirk.middleware.core.sphere.impl.BezirkId;
...
public final class CryptoEngine implements CryptoInternals {
    ...
    public final boolean generateKeys(String sphereId) {
        ...
        if (sphereId != null && !registry.isKeymapExist(sphereId)) {
            try {
                ...
                com.bezirk.middleware.core.sphere.security.SphereKeys sKeys = new com.bezirk.middleware.core.sphere.security.SphereKeys(new UPABlockCipherService().generateNewKey(128).getEncoded(),
    ...
    public final boolean generateKeys(String sphereId, boolean fromSphereId) {
        ...
        if (sphereId != null && !registry.isKeymapExist(sphereId)) {
            ...
            com.bezirk.middleware.core.sphere.security.SphereKeys sKeys = new com.bezirk.middleware.core.sphere.security.SphereKeys(sphereKey, pair);
    ...
    public final void addMemberKeys(String sphereId, com.bezirk.middleware.core.sphere.security.SphereKeys sphereKeys) {
        if (registry == null) {
            logger.error(REGISTRY_ERROR);
            return;
        }
    ...
    public SphereVitals getSphereVitals(String sphereId) {
        ...
        if (validateSphere(sphereId)) {
            com.bezirk.middleware.core.sphere.security.SphereKeys keys = registry.getSphereKeys(sphereId);
    ...
    private boolean validateSphereKey(String sphereId) {
        final com.bezirk.middleware.core.sphere.security.SphereKeys sphereKeys = registry.getSphereKeys(sphereId);
