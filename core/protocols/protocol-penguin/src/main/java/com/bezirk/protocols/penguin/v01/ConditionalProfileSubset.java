...
public class ConditionalProfileSubset extends ProfileSubset
{
	...
	// hasCondition
	public void setConditions (List<Condition> _v) { this.hasCondition = _v; }
	public List<Condition> getConditions () { return this.hasCondition; }
	public void addCondition (Condition _v) { this.hasCondition.add(_v); }
