...
public class ProfileSubset
{
	...
	// hasUserModel
	public void setUserModel (UserModel _v) { this.hasUserModel = _v; }
	public UserModel getUserModel () { return this.hasUserModel; }
	...
	// isSpecificTo
	public void setSpecificService (String _v) { this.isSpecificTo = _v; }
	public String getSpecificService () { return this.isSpecificTo; }
}
