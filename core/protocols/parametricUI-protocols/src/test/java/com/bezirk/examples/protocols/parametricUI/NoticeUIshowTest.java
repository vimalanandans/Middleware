...
public class NoticeUIshowTest {
    ...
    public void test() {
        ...
        String serializedNoticeUIshowPic = noticeUIshowPic.serialize();
        ...
        String serializedNoticeUIshowText = noticeUIshowText.serialize();
        ...
        String serializedNoticeUIshowVideo = noticeUIshowVideo.serialize();
