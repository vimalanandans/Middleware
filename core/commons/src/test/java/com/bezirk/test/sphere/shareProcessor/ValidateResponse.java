...
public class ValidateResponse {
    ...
    private static final Logger log = LoggerFactory.getLogger(ValidateResponse.class);
    ...
    public static void setUpBeforeClass() throws Exception {
        log.info("***** Setting up ShareProcessor:ValidateResponse TestCase *****");
    ...
    public static void tearDownAfterClass() throws Exception {
        log.info("***** Shutting down ShareProcessor:ValidateResponse TestCase *****");
