...
/**
 * TODO: move all the communication properties from CommsConfigurations.java here
 */
...
public class CommsProperties {
    ...
    public static void setINTERFACE_NAME(String INTERFACE_NAME) {
        CommsProperties.INTERFACE_NAME = INTERFACE_NAME;
    }
    ...
    public static void setMULTICAST_ADDRESS(String MULTICAST_ADDRESS) {
        CommsProperties.MULTICAST_ADDRESS = MULTICAST_ADDRESS;
    }
    ...
    public static void setMULTICAST_PORT(int MULTICAST_PORT) {
        CommsProperties.MULTICAST_PORT = MULTICAST_PORT;
    }
    ...
    public static void setStreamingEnabled(boolean isStreamingEnabled) {
        CommsProperties.isStreamingEnabled = isStreamingEnabled;
    }
    ...
    public static void setDOWNLOAD_PATH(String DOWNLOAD_PATH) {
        CommsProperties.DOWNLOAD_PATH = DOWNLOAD_PATH;
    }
    ...
    public static void setRemoteLoggingServiceEnabled(
        ...
        CommsProperties.isRemoteLoggingServiceEnabled = isRemoteLoggingServiceEnabled;
    }
