...
public class UnicastHeaderTest {
    ...
    public void testUnicastHeader() {
        ...
        com.bezirk.middleware.core.control.messages.UnicastHeader unicastHeader = prepareUnicastHeader();
    ...
    private com.bezirk.middleware.core.control.messages.UnicastHeader prepareUnicastHeader() {
        com.bezirk.middleware.core.control.messages.UnicastHeader unicastHeader = new com.bezirk.middleware.core.control.messages.UnicastHeader();
