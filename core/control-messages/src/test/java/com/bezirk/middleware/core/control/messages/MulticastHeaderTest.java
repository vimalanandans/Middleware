...
public class MulticastHeaderTest {
    ...
    public void testMulticastHeader() {
        ...
        com.bezirk.middleware.core.control.messages.MulticastHeader multicastHeader = prepareMulticastHeader();
    ...
    private com.bezirk.middleware.core.control.messages.MulticastHeader prepareMulticastHeader() {
        com.bezirk.middleware.core.control.messages.MulticastHeader multicastHeader = new com.bezirk.middleware.core.control.messages.MulticastHeader();
