...
public class DeviceInformationTest {
	...
	public void test() {
		...
		DeviceInformation deviceInformation = new DeviceInformation(deviceId, deviceName);
		...
		deviceName ="DeviceB";
		DeviceInformation deviceInfo = new DeviceInformation(deviceId, deviceName);
		...
		deviceId =null;
		deviceInfo = new DeviceInformation(deviceId, deviceName);
		...
		deviceInformation = new DeviceInformation(null, deviceName);
		deviceInfo = new DeviceInformation(null, deviceName);
