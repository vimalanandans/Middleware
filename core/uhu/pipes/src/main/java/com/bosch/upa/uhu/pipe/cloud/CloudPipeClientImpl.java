...
import com.bosch.upa.uhu.pipe.cloud.multipart.IncrementalParser;
import com.bosch.upa.uhu.pipe.cloud.multipart.MultiPartParser;
...
public class CloudPipeClientImpl implements CloudPipeClient {
	...
	protected MultiPartParser multiPartParser = new IncrementalParser();
