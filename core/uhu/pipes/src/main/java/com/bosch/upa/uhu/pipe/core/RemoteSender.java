...
import com.bosch.upa.uhu.control.messages.Header;
...
import com.bosch.upa.uhu.pipe.cloud.CloudPipeClient;
import com.bosch.upa.uhu.pipe.cloud.CloudPipeClientImpl;
...
public class RemoteSender implements Runnable {
	...
	protected void doCloudPipeSend(String serializedEvent, CloudPipe cloudPipe) {
		...
		CloudPipeClient client = new CloudPipeClientImpl(url, certFileName);
