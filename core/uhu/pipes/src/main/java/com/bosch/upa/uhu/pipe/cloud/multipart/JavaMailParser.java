...
import com.bosch.upa.uhu.pipe.cloud.StreamUtils;
...
public class JavaMailParser implements MultiPartParser {
	...
	public CloudStreamResponse parse(Map<String,List<String>> headerMap, InputStream inStream) throws Exception {
		 ...
		 * before passing it on to the receiving UhU service. This is true even if we use the 
		...
		response.setSerializedEvent(StreamUtils.getStringFromInputStream(descriptorPart.getInputStream()));
