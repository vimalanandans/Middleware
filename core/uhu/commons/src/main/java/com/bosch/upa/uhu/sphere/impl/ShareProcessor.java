...
public class ShareProcessor {
    ...
    public boolean processRequest(ShareRequest shareRequest) {
        ...
        if (storeData(inviterSphereId, sharerUhuDeviceInfo)) {
            ...
            sphereRegistryWrapper.updateListener(Operation.SHARE, Status.FAILURE, SHARE_FAILURE_MSG);
        ...
        sphereRegistryWrapper.updateListener(Operation.SHARE, Status.SUCCESS, "Share successful");
        return true;
    }
