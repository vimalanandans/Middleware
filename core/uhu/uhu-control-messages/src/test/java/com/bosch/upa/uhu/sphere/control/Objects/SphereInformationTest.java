...
public class SphereInformationTest {
	...
	public void testSphereInformation() {
		...
		SphereInformation sphereInformation =prepareSphereInformation();
	...
	private SphereInformation prepareSphereInformation() {
		SphereInformation sphereInformation = new SphereInformation();
