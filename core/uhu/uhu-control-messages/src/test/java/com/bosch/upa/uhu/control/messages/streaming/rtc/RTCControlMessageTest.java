...
import com.bosch.upa.uhu.control.messages.streaming.rtc.RTCControlMessage.RTCControlMessageType;
...
public class RTCControlMessageTest {
	...
	public void testRTCControlMessage() {
		...
		RTCControlMessage rtcControlMessage = new RTCControlMessage(sender, recipient, serverIp, uniqueKey, msgType, rtcMsg);
		String serializedMessage = rtcControlMessage.serialize();
		RTCControlMessage deserializedRTCControlMessage = RTCControlMessage
				.deserialize(serializedMessage, RTCControlMessage.class);
