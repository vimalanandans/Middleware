...
public class SphereCatchResponseTest {
	...
	public void testSphereCatchResponse() {
		...
		CatchResponse sphereCatchResonse = new CatchResponse(sender, catchSphereId, catchDeviceId, services );
		String serializedMessage = sphereCatchResonse.serialize();
		CatchResponse deserializedSphereCatchResponse = CatchResponse.deserialize(serializedMessage, CatchResponse.class);
