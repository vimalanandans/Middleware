...
public class CatchRequest extends MulticastControlMessage {
	...
	private final static Discriminator discriminator = ControlMessage.Discriminator.CatchRequest;
	 ...
	 *            short code of the inviting sphere. Has to be non-null.
	 * @param catcherSphereId
	 *            sphereId catching the services from the inviting sphere. Has to be non-null.
	 * @param uhuDeviceInfo
	 *            service and device information of the sphere catching the. Has to be non-null.
	 *            services
	 * @param sphereExchangeData
	 *            sphere information of the sphere catching the services. Has to be non-null.
	 */
