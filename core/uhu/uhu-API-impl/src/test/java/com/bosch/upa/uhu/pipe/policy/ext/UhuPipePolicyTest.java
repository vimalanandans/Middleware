package com.bosch.upa.uhu.pipe.policy.ext;
...
public class UhuPipePolicyTest {
	...
	public void test() {
		...
		UhuPipePolicy uhuPipePolicy = new UhuPipePolicy(pipePolicy);
		
		String serializedUhuPipePolicy =uhuPipePolicy.serialize();
		UhuPipePolicy deserializedUhuPipePolicy = UhuPipePolicy.deserialize(serializedUhuPipePolicy, UhuPipePolicy.class);
