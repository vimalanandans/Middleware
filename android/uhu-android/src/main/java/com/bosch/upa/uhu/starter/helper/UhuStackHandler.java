...
import com.bosch.upa.uhu.starter.UhuWifiManager;
...
public final class UhuStackHandler implements IUhuStackHandler {
    ...
    public void startStack(MainService service) {
        ...
        if (!UhuStackHandler.isStackStarted()) {
            ...
            if (uhuStartStackHelper.isWifiEnabled(wifi)) {
                 ...
                 *************************************************************/
                if (!uhuStartStackHelper.isIPAddressValid(service, wifi,androidNetworkUtil)) return;
    ...
    public static IUhuDevMode getDevMode() {return UhuSphereHandler.devMode;}
