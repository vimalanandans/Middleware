...
import com.bosch.upa.uhu.discovery.DiscoveryProcessor;
import com.bosch.upa.uhu.discovery.DiscoveryRecord;
...
import com.bosch.upa.uhu.sadl.ISadlRegistry;
...
public class ProxyforServices implements UhuProxyForServiceAPI {
    ...
    public void sendUnicastEvent(final UhuServiceId serviceId, final UhuServiceEndPoint recipient, final String serializedEventMsg) {
        ...
        while(sphereIterator.hasNext()){
            ...
            else{ log.error("Comms manager not initialized");
            }
        }
