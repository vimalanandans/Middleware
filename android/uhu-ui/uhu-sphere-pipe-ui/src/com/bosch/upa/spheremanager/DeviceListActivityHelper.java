package com.bosch.upa.spheremanager;
...
import com.bosch.upa.spheremanager.ui.DeviceListFragment;
import com.bosch.upa.spheremanager.ui.PipeListFragment;
import com.bosch.upa.spheremanager.ui.listitems.SphereListItem;
...
public class DeviceListActivityHelper {
    ...
    void setImageSourceForSphereType(ImageView img, SphereListItem entry) {
        if (entry.getmSphere().getSphereType().equals(UhuSphereType.UHU_SPHERE_TYPE_HOME)) {
            img.setImageResource(R.drawable.ic_home_sphere);
        } else if (entry.getmSphere().getSphereType().equals(UhuSphereType.UHU_SPHERE_TYPE_DEFAULT)) {
            img.setImageResource(R.drawable.ic_default_sphere);
        } else if (entry.getmSphere().getSphereType().equals(UhuSphereType.UHU_SPHERE_TYPE_CAR)) {
            img.setImageResource(R.drawable.ic_car_sphere);
        } else if (entry.getmSphere().getSphereType().equals(UhuSphereType.UHU_SPHERE_TYPE_OFFICE)) {
            img.setImageResource(R.drawable.ic_office_sphere);
        } else if (entry.getmSphere().getSphereType().equals(UhuSphereType.UHU_SPHERE_TYPE_HOME_CONTROL)) {
            img.setImageResource(R.drawable.ic_home_control_sphere);
        } else if (entry.getmSphere().getSphereType().equals(UhuSphereType.UHU_SPHERE_TYPE_HOME_ENTERTAINMENT)) {
            img.setImageResource(R.drawable.ic_home_entertainment_sphere);
        } else if (entry.getmSphere().getSphereType().equals(UhuSphereType.UHU_SPHERE_TYPE_HOME_SECURITY)) {
